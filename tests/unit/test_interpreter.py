...
class TestInterpreter:
    ...
    def interpreter(self, cmds_implementation):
        ...
        interp.add_command(Command(
            ['cmd_with_parameters', basic_types.StringType(), basic_types.StringType()],
            cmds_implementation.cmd_with_parameters, cmd_id='id2'
        ))
        interp.add_command(Command(
            ['cmd_with_ops', basic_types.OptionsType(['op1', 'op2'])],
            cmds_implementation.cmd_with_ops, cmd_id='id3'
        ))
        interp.add_command(Command(
            ['cmd_with_regex', basic_types.RegexType('^start.*')],
            cmds_implementation.cmd_with_regex, cmd_id='id4'
        ))
        return interp
    ...
    class TestCommandExecution:
        class TestWhenEvaluatingMultipleLines:
            def test_executes_each_line_command(self, interpreter, cmds_implementation):
                ...
                assert_that(cmds_implementation.cmd,
                            called().with_args(tokens=['cmd', 'key'],
                                               interpreter=interpreter,
                                               cmd_id='id1'))
                assert_that(cmds_implementation.cmd_with_parameters,
                            called().with_args('s1', 's2',
        ...
        class TestOptionsParameters:
            def test_executes_command_with_valid_option(self, interpreter, cmds_implementation):
                ...
                assert_that(cmds_implementation.cmd_with_ops,
        ...
        class TestRegexParameter:
            def test_executes_command_when_parameter_matches_regex(self, interpreter, cmds_implementation):
                ...
                assert_that(cmds_implementation.cmd_with_regex,
    ...
    class TestCommandExecutionWithAbbreviations:
        ...
        def test_executes_perfect_match_over_abbreviated_match(self, interpreter, cmds_implementation):
            ...
            assert_that(cmds_implementation.perfect_match,
    ...
    class TestCommandExecutionWithAutoexpansion:
        def test_expands_parameter_to_unique_autocompletion(self, interpreter, cmds_implementation):
            interpreter.add_command(Command(
                ['cmd1', basic_types.OptionsType(['firstOp', 'secondOp'])],
                cmds_implementation.cmd1
            ))

            interpreter.eval('cmd1 first')

            assert_that(cmds_implementation.cmd1,
        ...
        def test_expands_all_parameters_with_unique_autocompletions(self, interpreter, cmds_implementation):
            ...
            assert_that(cmds_implementation.cmd1,
                        called().with_args('firstOp', 'secondOp',
